...
//get all rects and update field based on their year
...
function drawBar(data, dataType, country) {
  ...
  //filter appropriate contry and sort by year
  var countryData = data.filter(d => d.country === country)
                        .sort((a, b) => a.year - b.year);

  //create X, Y scales with a barwidth
  ...
  //update titile and y axis label based on the data in country
